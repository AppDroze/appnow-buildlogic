...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            from("com.appnow.build:appnow-catalog:0.2.0") // or 0.2.0-SNAPSHOT
        }
    }
}
```
...
plugins {
    // For KMP libraries
    id("appnow.kmp.library") version "0.2.0"
    
    // For KMP libraries with Compose 
    id("appnow.kmp.compose") version "0.2.0"
    
    // For Android applications
    id("appnow.android.app") version "0.2.0"
}
...
Then use version `0.2.0` in your consumer projects.

### 6. Available Versions

- **Releases**: `0.2.0` (from GitHub releases/tags)
- **Snapshots**: `0.2.0-SNAPSHOT` (from main branch pushes)
- **Local**: `0.2.0` (from local publishing)
